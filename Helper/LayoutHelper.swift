...
struct LayoutHelper {
    /// Returns bottom padding for ads based on the provided screen height.
    /// Pass the container's height from UI context (e.g., GeometryReader in SwiftUI).
    static func adBottomPadding(forHeight screenHeight: CGFloat) -> CGFloat {
        switch screenHeight {
        case ..<670:
